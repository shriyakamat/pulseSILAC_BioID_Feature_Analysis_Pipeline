...
## UNIVERSAL VARIABLES ##
mylevhmn=c(
"tcl_duplicate","HS_ns_lc","HS_other_lc","tcl","human")
## READ DATA ##
...
HS_ns_lc = read.table("src/HS_ns_lc.txt")
HS_other_lc = read.table("src/HS_other_lc.txt")
...
#
 ...
 my.aam      <- rbind(my.aam,my.tmp)
#
 my.tmp      <- ref.hmn[which(ref.hmn$nam %in% HS_ns_lc$V1),]
 my.tmp$tag <- "HS_ns_lc"
 my.hmn      <- rbind(my.hmn,my.tmp)
 my.tmp      <- ref.aam[which(ref.aam$nam %in% HS_ns_lc$V1),]
 my.tmp$tag <- "HS_ns_lc"
 my.aam      <- rbind(my.aam,my.tmp)
#
 my.tmp      <- ref.hmn[which(ref.hmn$nam %in% HS_other_lc$V1),]
 my.tmp$tag <- "HS_other_lc"
 my.hmn      <- rbind(my.hmn,my.tmp)
 my.tmp      <- ref.aam[which(ref.aam$nam %in% HS_other_lc$V1),]
 my.tmp$tag <- "HS_other_lc"
 my.aam      <- rbind(my.aam,my.tmp)
#
###########
...
#
## pap_cnt ##
barplot(c(length(my.hmn[which(my.hmn$tag=="tcl" & my.hmn$pap_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="tcl"),]$nam),length(my.hmn[which(my.hmn$tag=="tcl_duplicate" & my.hmn$pap_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="tcl_duplicate"),]$nam),length(my.hmn[which(my.hmn$tag=="HS_ns_lc" & my.hmn$pap_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="HS_ns_lc"),]$nam),length(my.hmn[which(my.hmn$tag=="HS_other_lc" & my.hmn$pap_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="HS_other_lc"),]$nam),length(my.hmn[which(my.hmn$tag=="human" & my.hmn$pap_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="human"),]$nam)),ylab="pap_cnt Fraction",names=c("tcl","tcl_duplicate","HS_ns_lc","HS_other_lc","human"),col=c("firebrick","firebrick","firebrick","firebrick","gainsboro"))
## plc_cnt ##
barplot(c(length(my.hmn[which(my.hmn$tag=="tcl" & my.hmn$plc_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="tcl"),]$nam),length(my.hmn[which(my.hmn$tag=="tcl_duplicate" & my.hmn$plc_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="tcl_duplicate"),]$nam),length(my.hmn[which(my.hmn$tag=="HS_ns_lc" & my.hmn$plc_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="HS_ns_lc"),]$nam),length(my.hmn[which(my.hmn$tag=="HS_other_lc" & my.hmn$plc_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="HS_other_lc"),]$nam),length(my.hmn[which(my.hmn$tag=="human" & my.hmn$plc_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="human"),]$nam)),ylab="plc_cnt Fraction",names=c("tcl","tcl_duplicate","HS_ns_lc","HS_other_lc","human"),col=c("firebrick","firebrick","firebrick","firebrick","gainsboro"))
## rbp_cnt ##
barplot(c(length(my.hmn[which(my.hmn$tag=="tcl" & my.hmn$rbp_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="tcl"),]$nam),length(my.hmn[which(my.hmn$tag=="tcl_duplicate" & my.hmn$rbp_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="tcl_duplicate"),]$nam),length(my.hmn[which(my.hmn$tag=="HS_ns_lc" & my.hmn$rbp_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="HS_ns_lc"),]$nam),length(my.hmn[which(my.hmn$tag=="HS_other_lc" & my.hmn$rbp_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="HS_other_lc"),]$nam),length(my.hmn[which(my.hmn$tag=="human" & my.hmn$rbp_cnt==1),]$nam) / length(my.hmn[which(my.hmn$tag=="human"),]$nam)),ylab="rbp_cnt Fraction",names=c("tcl","tcl_duplicate","HS_ns_lc","HS_other_lc","human"),col=c("firebrick","firebrick","firebrick","firebrick","gainsboro"))
dev.off()
#
###############
# AA Plot
...
###########
#
p_dis <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$dis, my.hmn[which(my.hmn$tag=='human'),]$dis)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$dis, my.hmn[which(my.hmn$tag=='human'),]$dis)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$dis, my.hmn[which(my.hmn$tag=='tcl'),]$dis)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$dis, my.hmn[which(my.hmn$tag=='tcl'),]$dis)$p.val)
p_len <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$len, my.hmn[which(my.hmn$tag=='human'),]$len)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$len, my.hmn[which(my.hmn$tag=='human'),]$len)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$len, my.hmn[which(my.hmn$tag=='tcl'),]$len)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$len, my.hmn[which(my.hmn$tag=='tcl'),]$len)$p.val)
p_run <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$run, my.hmn[which(my.hmn$tag=='human'),]$run)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$run, my.hmn[which(my.hmn$tag=='human'),]$run)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$run, my.hmn[which(my.hmn$tag=='tcl'),]$run)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$run, my.hmn[which(my.hmn$tag=='tcl'),]$run)$p.val)
p_max <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$max, my.hmn[which(my.hmn$tag=='human'),]$max)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$max, my.hmn[which(my.hmn$tag=='human'),]$max)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$max, my.hmn[which(my.hmn$tag=='tcl'),]$max)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$max, my.hmn[which(my.hmn$tag=='tcl'),]$max)$p.val)
p_chg <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$chg, my.hmn[which(my.hmn$tag=='human'),]$chg)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$chg, my.hmn[which(my.hmn$tag=='human'),]$chg)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$chg, my.hmn[which(my.hmn$tag=='tcl'),]$chg)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$chg, my.hmn[which(my.hmn$tag=='tcl'),]$chg)$p.val)
p_net <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$net, my.hmn[which(my.hmn$tag=='human'),]$net)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$net, my.hmn[which(my.hmn$tag=='human'),]$net)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$net, my.hmn[which(my.hmn$tag=='tcl'),]$net)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$net, my.hmn[which(my.hmn$tag=='tcl'),]$net)$p.val)
p_abd_log <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$abd_log, my.hmn[which(my.hmn$tag=='human'),]$abd_log)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$abd_log, my.hmn[which(my.hmn$tag=='human'),]$abd_log)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$abd_log, my.hmn[which(my.hmn$tag=='tcl'),]$abd_log)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$abd_log, my.hmn[which(my.hmn$tag=='tcl'),]$abd_log)$p.val)
p_gvy <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$gvy, my.hmn[which(my.hmn$tag=='human'),]$gvy)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$gvy, my.hmn[which(my.hmn$tag=='human'),]$gvy)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$gvy, my.hmn[which(my.hmn$tag=='tcl'),]$gvy)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$gvy, my.hmn[which(my.hmn$tag=='tcl'),]$gvy)$p.val)
p_pip <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$pip, my.hmn[which(my.hmn$tag=='human'),]$pip)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$pip, my.hmn[which(my.hmn$tag=='human'),]$pip)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$pip, my.hmn[which(my.hmn$tag=='tcl'),]$pip)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$pip, my.hmn[which(my.hmn$tag=='tcl'),]$pip)$p.val)
p_iac <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$iac, my.hmn[which(my.hmn$tag=='human'),]$iac)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$iac, my.hmn[which(my.hmn$tag=='human'),]$iac)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$iac, my.hmn[which(my.hmn$tag=='tcl'),]$iac)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$iac, my.hmn[which(my.hmn$tag=='tcl'),]$iac)$p.val)
p_mfc <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$mfc, my.hmn[which(my.hmn$tag=='human'),]$mfc)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$mfc, my.hmn[which(my.hmn$tag=='human'),]$mfc)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$mfc, my.hmn[which(my.hmn$tag=='tcl'),]$mfc)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$mfc, my.hmn[which(my.hmn$tag=='tcl'),]$mfc)$p.val)
p_csl <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$csl, my.hmn[which(my.hmn$tag=='human'),]$csl)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$csl, my.hmn[which(my.hmn$tag=='human'),]$csl)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$csl, my.hmn[which(my.hmn$tag=='tcl'),]$csl)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$csl, my.hmn[which(my.hmn$tag=='tcl'),]$csl)$p.val)
p_tsl <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$tsl, my.hmn[which(my.hmn$tag=='human'),]$tsl)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$tsl, my.hmn[which(my.hmn$tag=='human'),]$tsl)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$tsl, my.hmn[which(my.hmn$tag=='tcl'),]$tsl)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$tsl, my.hmn[which(my.hmn$tag=='tcl'),]$tsl)$p.val)
p_ssa <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$ssa, my.hmn[which(my.hmn$tag=='human'),]$ssa)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$ssa, my.hmn[which(my.hmn$tag=='human'),]$ssa)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$ssa, my.hmn[which(my.hmn$tag=='tcl'),]$ssa)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$ssa, my.hmn[which(my.hmn$tag=='tcl'),]$ssa)$p.val)
p_ssb <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$ssb, my.hmn[which(my.hmn$tag=='human'),]$ssb)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$ssb, my.hmn[which(my.hmn$tag=='human'),]$ssb)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$ssb, my.hmn[which(my.hmn$tag=='tcl'),]$ssb)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$ssb, my.hmn[which(my.hmn$tag=='tcl'),]$ssb)$p.val)
p_ssc <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$ssc, my.hmn[which(my.hmn$tag=='human'),]$ssc)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$ssc, my.hmn[which(my.hmn$tag=='human'),]$ssc)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$ssc, my.hmn[which(my.hmn$tag=='tcl'),]$ssc)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$ssc, my.hmn[which(my.hmn$tag=='tcl'),]$ssc)$p.val)
p_pol <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$pol, my.hmn[which(my.hmn$tag=='human'),]$pol)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$pol, my.hmn[which(my.hmn$tag=='human'),]$pol)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$pol, my.hmn[which(my.hmn$tag=='tcl'),]$pol)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$pol, my.hmn[which(my.hmn$tag=='tcl'),]$pol)$p.val)
p_tmx <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$tmx, my.hmn[which(my.hmn$tag=='human'),]$tmx)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$tmx, my.hmn[which(my.hmn$tag=='human'),]$tmx)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$tmx, my.hmn[which(my.hmn$tag=='tcl'),]$tmx)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$tmx, my.hmn[which(my.hmn$tag=='tcl'),]$tmx)$p.val)
p_toh <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$toh, my.hmn[which(my.hmn$tag=='human'),]$toh)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$toh, my.hmn[which(my.hmn$tag=='human'),]$toh)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$toh, my.hmn[which(my.hmn$tag=='tcl'),]$toh)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$toh, my.hmn[which(my.hmn$tag=='tcl'),]$toh)$p.val)
p_sst <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$sst, my.hmn[which(my.hmn$tag=='human'),]$sst)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$sst, my.hmn[which(my.hmn$tag=='human'),]$sst)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$sst, my.hmn[which(my.hmn$tag=='tcl'),]$sst)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$sst, my.hmn[which(my.hmn$tag=='tcl'),]$sst)$p.val)
p_phs <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$phs, my.hmn[which(my.hmn$tag=='human'),]$phs)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$phs, my.hmn[which(my.hmn$tag=='human'),]$phs)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$phs, my.hmn[which(my.hmn$tag=='tcl'),]$phs)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$phs, my.hmn[which(my.hmn$tag=='tcl'),]$phs)$p.val)
p_mag <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$mag, my.hmn[which(my.hmn$tag=='human'),]$mag)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$mag, my.hmn[which(my.hmn$tag=='human'),]$mag)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$mag, my.hmn[which(my.hmn$tag=='tcl'),]$mag)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$mag, my.hmn[which(my.hmn$tag=='tcl'),]$mag)$p.val)
p_rbp <- c(wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$rbp, my.hmn[which(my.hmn$tag=='human'),]$rbp)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$rbp, my.hmn[which(my.hmn$tag=='human'),]$rbp)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_ns_lc'),]$rbp, my.hmn[which(my.hmn$tag=='tcl'),]$rbp)$p.val,wilcox.test(my.hmn[which(my.hmn$tag=='HS_other_lc'),]$rbp, my.hmn[which(my.hmn$tag=='tcl'),]$rbp)$p.val)
...
#
HS_ns_lc_vs_pme <- p.adjust(p_hmn[,1],method="hochberg")
HS_other_lc_vs_pme <- p.adjust(p_hmn[,2],method="hochberg")
HS_ns_lc_vs_tcl <- p.adjust(p_hmn[,3],method="hochberg")
HS_other_lc_vs_tcl <- p.adjust(p_hmn[,4],method="hochberg")
corr_pval<-cbind(HS_ns_lc_vs_pme,HS_other_lc_vs_pme,HS_ns_lc_vs_tcl,HS_other_lc_vs_tcl)
